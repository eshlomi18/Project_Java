...
public class ReflectionRefractionTests {
     ...
     */
    @Test
    public void twoSpheresOnMirrors() throws MissingResourcesException, UnsupportedOperationException {
        Intersectable.set_actBoundingBox(true);
     ...
     */
    @Test
    public void trianglesTransparentSphere() throws MissingResourcesException, UnsupportedOperationException {
        Intersectable.set_actBoundingBox(true);
        ...
        scene.geometries.add( //
                ...
                new Triangle(new Point3D(-150, -150, -115), new Point3D(-70, 70, -140), new Point3D(75, 75, -150)) //
                        .setMaterial(new Material().setKd(0.5).setKd(0.5).setShininess(60)), //

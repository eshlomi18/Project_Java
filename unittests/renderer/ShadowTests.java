...
public class ShadowTests {
	...
	public void sphereTriangleInitial2() throws MissingResourcesException, UnsupportedOperationException {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-100, -100, 150), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
	...
	public void sphereTriangleInitial3() throws MissingResourcesException, UnsupportedOperationException {
		...
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-73, -73, 57), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
	...
	public void sphereTriangleInitial4() throws MissingResourcesException, UnsupportedOperationException {
		scene.geometries.add( //
				new Sphere(60, new Point3D(0, 0, -200)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)), //
				new Triangle(new Point3D(-47, -17, 23), new Point3D(-17, -47, 23), new Point3D(-45, -45, 19)) //
						.setEmission(new Color(java.awt.Color.BLUE)) //
						.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(30)) //
		);
		scene.lights.add( //
				new SpotLight(new Color(400, 240, 0), new Point3D(-100, -100, 270), new Vector(1, 1, -3)) //
						.setKl(1E-5).setKq(1.5E-7));
